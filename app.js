...
function initCornerLogo() {
  const logo = document.getElementById("siteCornerLogo");
  if (!logo) return;

  const candidates = [
    "MH FUNGI LOGO limegreen.png",
    "./MH FUNGI LOGO limegreen.png",
    "/MH FUNGI LOGO limegreen.png",
    "MH%20FUNGI%20LOGO%20limegreen.png",
    "./MH%20FUNGI%20LOGO%20limegreen.png",
    "/MH%20FUNGI%20LOGO%20limegreen.png",
    "assets/MH FUNGI LOGO limegreen.png",
    "./assets/MH FUNGI LOGO limegreen.png",
    "/assets/MH FUNGI LOGO limegreen.png",
    "MH_FUNGI_LOGO_limegreen.png",
    "./MH_FUNGI_LOGO_limegreen.png",
    "/MH_FUNGI_LOGO_limegreen.png",
  ];
